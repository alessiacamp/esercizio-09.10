...
while (i < starWarsCharacters.length) {
  crewMess += starWarsCharacters[i].mass;
  i++;
}
console.log(crewMess);
/* ESERCIZIO 7
...
} else if (crewMess > 500 && crewMess < 700) {
  console.log("Ship is half loaded");
} else if (crewMess > 700 && crewMess < 900) {
  console.log("Warning: Load is over 700");
} else if (crewMess > 900 && crewMess < 1000) {
  console.log("Critical Load: Over 900");
} else if (crewMess > 1000) {
